...
<section class="py-5 text-white" style="background: linear-gradient(135deg, #0d6efd, #0b5ed7);">
  <div class="container text-center">
    <h1 class="display-4 fw-bold mb-3">🏡 Your New Townhome is Waiting</h1>
    <p class="lead mb-4">
      Live big in a <strong>3-bedroom, 2.5-bath</strong> townhome with <strong>2,580 sq ft</strong> of space — all for just <strong>$399,000</strong>.
    </p>
    ...
    <p class="mb-3 fw-semibold">
      Limited-time financing available — these won’t last long!
    </p>

    <a href="#leadForm" class="btn btn-light btn-lg fw-bold px-5 py-3">Get More Info</a>
  </div>
</section>
      ...
      <div class="row align-items-center justify-content-between">
        ...
        <div class="col-lg-4 text-center text-lg-start">
          ...
          <p class="fs-5 fw-semibold text-dark mb-2 text-center">
            Only through <strong>Priority Homes</strong> — your trusted local builder.
          </p>
          <p class="text-danger fw-bold mb-0 text-center">
            ⏳ Offer ends June 30th — schedule your visit today!
          </p>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    <div class="row align-items-center">
      ...
      <div class="col-lg-6 mb-4 mb-lg-0">
        <h2 class="fw-bold mb-3">Modern Comfort Meets Small-Town Charm</h2>
        <p class="text-muted">
          Imagine peaceful evenings, mountain views, and plenty of space to grow — all just minutes from the heart of Nephi. These homes offer unbeatable value and stylish design you’ll love coming home to.
        </p>
      ...
      <div class="col-lg-6">
        <div class="card shadow">
          <div class="card-body">
            <h3 class="card-title text-center mb-4">Request More Info</h3>
